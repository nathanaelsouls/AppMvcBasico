...
namespace AppMvcBasica.Controllers
{
    ...
    public class ProdutosController : Controller
    {
        ...
        {
            ViewData["FornecedorId"] = new SelectList(_context.Fornecedores, "Id", "Name");
        ...
        public async Task<IActionResult> Create(Produto produto)
        {
            ...
            ViewData["FornecedorId"] = new SelectList(_context.Fornecedores, "Id", "Name", produto.FornecedorId);
            return View(produto);
        }
